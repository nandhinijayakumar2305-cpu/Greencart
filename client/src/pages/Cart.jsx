            ...
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    Shopping Cart <span className="text-sm text-primary">
                        {getCartCount ? getCartCount() : 0} Items</span>
                </h1>
                ...
                {(cartArray || []).map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        ...
                        <p className="text-center">{currency}{(product.offerPrice || 0) * (product.quantity || 0)}</p>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        <button onClick={() => { getUserAddress(); setShowAddress(!showAddress) }} className="text-primary hover:underline cursor-pointer">
                            Change
                        </button>
                        {showAddress && (
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between text-lg font-medium mt-3">
                        <span>Total Amount:</span><span>
                            {currency}{getCartAmount ? getCartAmount() + getCartAmount() * 2 / 100 : 0}</span>
                    </p>
                </div>
